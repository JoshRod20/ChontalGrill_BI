...
import html2canvas from 'html2canvas';
            ...
            fetch('http://localhost:5000/estadisticas/ordenespormesdeanio')
                ...
                let y = 150;
                    ...
                    ordenes2.forEach((orden) => {
                        ...
                        pdf.text(`Cantidad total de órdenes por mes: ${orden.Cantidad}`, 20, y + 10);
            ...
            fetch('http://localhost:5000/estadisticas/ordenespordiayanio')
                ...
                let y = 150;
                    ...
                    ordenes2.forEach((orden) => {
                        ...
                        pdf.text(`Cantidad total de órdenes por dia: ${orden.Cantidad}`, 20, y + 10);
    ...
    const [ordenes4, setOrdenes4] = useState([]); // Estado 'ordenes2' con su función 'setOrdenes2'
    const [myChart4, setMyChart4] = useState(null); // Estado 'myChart2' con su función 'setMyChart2'
    ...
    useEffect(() => {
        if (ordenes4.length > 0) {
            ...
            const pedido = ordenes4.map((orden4) => orden4.Pedido);
            ...
            fetch('http://localhost:5000/estadisticas/ordenestotalesporpedido')
                ...
                let y = 150;
                    ...
                    ordenes4.forEach((orden) => {
                        ...
                        pdf.text(`Cantidad total de órdenes por pedido: ${orden.Cantidad}`, 20, y + 10);
            ...
            <Container className="margen-conten" responsive>
                <Row className="g-3">
                    ...
                    <Col sm="6" md="6" lg="6">
                        <Card>
                            <Card.Body>
                                <Card.Title className='title'>Cantidad de órdenes por mes</Card.Title>
